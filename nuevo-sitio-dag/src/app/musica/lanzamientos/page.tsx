                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-3">
                        <button className="flex items-center px-4 py-2 bg-dag-burgundy text-dag-white rounded-lg font-medium hover:bg-dag-burgundy/90 transition-colors duration-300">
