            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 bg-dag-white border border-dag-ivory rounded-lg focus:outline-none focus:ring-2 focus:ring-dag-golden text-dag-burgundy"
                />
              </div>
              <button className="flex items-center px-4 py-2 bg-dag-golden text-dag-burgundy rounded-lg font-medium hover:bg-dag-ivory transition-colors duration-300">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2 mt-4">
                    <button className="flex-1 flex items-center justify-center px-4 py-2 bg-dag-burgundy text-dag-white rounded-lg font-medium hover:bg-dag-burgundy/90 transition-colors duration-300">
                      <Play className="w-4 h-4 mr-2" />
                      Escuchar
                    </button>
                    <button className="px-4 py-2 border border-dag-golden text-dag-burgundy rounded-lg font-medium hover:bg-dag-golden hover:text-dag-burgundy transition-all duration-300">
