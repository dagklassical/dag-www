            ...
            <div className="grid md:grid-cols-2 gap-4">
              {sections.map((section) => (
                <a
                  key={section.id}
                  href={`#${section.id}`}
                  className="flex items-center p-4 bg-dag-white rounded-lg shadow-sm border border-dag-ivory hover:shadow-md transition-shadow duration-300"
                >
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {keyTerms.map((item) => (
                <div
                  key={item.term}
                  className="bg-dag-white rounded-lg p-6 shadow-sm border border-dag-ivory"
                >
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link
                ...
                className="block p-4 bg-dag-white rounded-lg shadow-sm border border-dag-ivory hover:shadow-md transition-shadow duration-300"
              >
