          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-12 items-center">
              ...
              <div className="lg:col-span-1">
                <div className="aspect-square bg-gradient-to-br from-dag-burgundy to-dag-caramel rounded-2xl flex items-center justify-center text-dag-white">
              ...
              <div className="lg:col-span-2 text-center lg:text-left">
                ...
                <h1 className="text-4xl lg:text-5xl font-light text-dag-burgundy mb-4 tracking-wide">
                  Danilo Álvarez
                </h1>
                <p className="text-2xl text-dag-caramel mb-6 font-medium">
                  Fundador & Director Musical DAG Klassical
                </p>
                <p className="text-lg text-dag-caramel mb-8 leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <Link
                    ...
                    className="inline-flex items-center px-6 py-3 bg-dag-burgundy text-dag-white rounded-xl font-medium hover:bg-dag-burgundy/90 transition-all duration-300"
                  >
                  ...
                  <Link
                    href="/contacto"
                    className="inline-flex items-center px-6 py-3 border-2 border-dag-golden text-dag-burgundy rounded-xl font-medium hover:bg-dag-golden hover:text-dag-burgundy transition-all duration-300"
                  >
                    Contactar
                  </Link>
                </div>
        ...
        <div className="container-max section-padding">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <div className="bg-dag-white rounded-2xl p-8 shadow-lg border border-dag-ivory mb-8">
                <Quote className="w-8 h-8 text-dag-golden mb-4" />
                <p className="text-lg text-dag-caramel leading-relaxed italic mb-6">
                ...
                <div className="text-dag-burgundy font-medium">— Danilo Álvarez, 2024</div>
              </div>

              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-semibold text-dag-burgundy mb-4">Formación Musical</h3>
                  ...
                  <h3 className="text-xl font-semibold text-dag-burgundy mb-4 mt-6">Trayectoria Técnica</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-dag-burgundy mb-4">Visión Empresarial</h3>
                  <p className="text-dag-caramel leading-relaxed mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-dag-burgundy mb-4 mt-6">Impacto Global</h3>
                  <p className="text-dag-caramel leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {achievements.map((achievement) => {
              ...
              return (
                ...
                >
                  <div className={`inline-flex p-4 rounded-xl bg-gradient-to-r ${achievement.color} text-dag-white mb-6`}>
                    <Icon className="w-8 h-8" />
                  </div>
                  <div className="text-2xl font-bold text-dag-burgundy mb-2">{achievement.year}</div>
                  <h3 className="text-xl font-semibold text-dag-burgundy mb-3">{achievement.title}</h3>
                  <p className="text-dag-caramel leading-relaxed">{achievement.description}</p>
                </div>
              )
            })}
          </div>
              ...
              {expertise.map((skill) => (
                <div key={skill.area}>
                  <div className="flex justify-between items-center mb-2">
                    <span className="font-medium text-dag-burgundy">{skill.area}</span>
                    <span className="text-dag-caramel">{skill.level}%</span>
                  </div>
                  <div className="w-full bg-dag-ivory rounded-full h-3">
                    <div 
                      className="bg-dag-golden h-3 rounded-full transition-all duration-1000"
            ...
            {philosophy.map((principle) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-dag-burgundy mb-4">{principle.title}</h3>
                  <p className="text-dag-caramel leading-relaxed">{principle.description}</p>
                </div>
              )
            })}
          </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-3">
                      <h3 className="text-xl font-semibold text-dag-burgundy">{project.title}</h3>
                      <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                        project.status === 'En Desarrollo' ? 'bg-dag-golden/20 text-dag-burgundy' :
                        project.status === 'Planificación' ? 'bg-dag-burgundy/20 text-dag-burgundy' :
                        'bg-dag-caramel/20 text-dag-caramel'
                      }`}>
                        {project.status}
                      </span>
                    </div>
                    <p className="text-dag-caramel mb-4">{project.description}</p>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-semibold text-dag-burgundy">{project.year}</div>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="container-max section-padding">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <Quote className="w-8 h-8 text-dag-golden mb-4" />
                <p className="text-dag-caramel leading-relaxed mb-6 italic">
                  "{testimonial.quote}"
                </p>
                <div>
                  <div className="font-semibold text-dag-burgundy">{testimonial.author}</div>
                  <div className="text-sm text-dag-caramel">{testimonial.role}</div>
                </div>
              </div>
            ))}
          </div>
