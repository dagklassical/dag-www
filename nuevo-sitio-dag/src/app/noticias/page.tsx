          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            {noticias.filter(noticia => noticia.destacado).map((noticia) => (
              <article key={noticia.id} className="card group cursor-pointer">
                <div className="aspect-video bg-gradient-to-br from-dag-burgundy to-dag-caramel rounded-lg mb-6 flex items-center justify-center">
        ...
        <div className="container-max section-padding">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {noticias.map((noticia) => (
              <article key={noticia.id} className="card group cursor-pointer">
                <div className="aspect-video bg-dag-ivory rounded-lg mb-4 flex items-center justify-center">
