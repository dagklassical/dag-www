                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-dag-ivory rounded-xl focus:ring-2 focus:ring-dag-golden focus:border-dag-golden transition-colors duration-300"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 border border-dag-ivory rounded-xl focus:ring-2 focus:ring-dag-golden focus:border-dag-golden transition-colors duration-300 resize-none"
