...
export default function Header() {
  ...
  const navigation = [
    ...
    { name: 'Virginia Ramírez', href: '/virginia-ramirez', icon: Users },
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            <div className="relative">
              <div className="w-12 h-12 bg-dag-burgundy rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
            ...
            {navigation.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  href={item.href}
                  className="flex items-center space-x-2 px-4 py-2 rounded-lg text-dag-caramel hover:text-dag-burgundy hover:bg-dag-ivory transition-all duration-300 group"
                >
              ...
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className="flex items-center space-x-3 px-4 py-3 rounded-lg text-dag-caramel hover:text-dag-burgundy hover:bg-dag-ivory transition-all duration-300 group"
                  >
