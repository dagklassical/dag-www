        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-dag-golden rounded-lg flex items-center justify-center">
            ...
            <p className="text-dag-ivory mb-6 leading-relaxed max-w-md">
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 bg-dag-golden rounded-lg flex items-center justify-center text-dag-burgundy hover:bg-dag-white transition-colors duration-300"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold text-dag-golden mb-4">Navegación</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-semibold text-dag-golden mb-4">Contacto</h3>
