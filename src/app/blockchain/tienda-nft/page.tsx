            ...
            <div className="lg:w-64">
              ...
              <div className="space-y-2">
                {filters.map((filter) => (
                  <button
                    key={filter.name}
                    className="w-full text-left px-4 py-2 text-dag-caramel hover:bg-dag-ivory rounded-xl transition-all duration-300"
                  >
                    {filter.name}
                  </button>
                ))}
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-dag-white border border-dag-ivory rounded-xl focus:outline-none focus:ring-2 focus:ring-dag-golden text-dag-burgundy"
                  />
                </div>
                <button className="flex items-center px-6 py-3 bg-dag-golden text-dag-burgundy rounded-xl font-medium hover:bg-dag-ivory transition-colors duration-300">
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex gap-3">
                        <button 
                          className={`flex-1 py-3 rounded-xl font-medium transition-colors duration-300 ${
                            nft.soldOut
                        ...
                        <button className="px-4 py-3 border border-dag-golden text-dag-burgundy rounded-xl font-medium hover:bg-dag-golden hover:text-dag-white transition-all duration-300">
