          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            {eventos.filter(evento => evento.destacado).map((evento) => (
              <article key={evento.id} className="card group relative overflow-hidden">
                ...
                <div className="aspect-video bg-gradient-to-br from-dag-burgundy to-dag-caramel rounded-xl mb-6 flex items-center justify-center relative">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-4">
                    ...
                    <Link
                      ...
                      className={`inline-flex items-center space-x-2 px-6 py-3 rounded-xl font-medium transition-all duration-300 ${
                        evento.disponible
                          ? 'btn-primary'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {eventos.map((evento) => (
              <article key={evento.id} className="card group relative">
                <div className="aspect-video bg-dag-ivory rounded-xl mb-4 flex items-center justify-center relative">
